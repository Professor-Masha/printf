...
/********************* PRINT THE STRING **********************/
/**
 * print_string - A funtion Prints a string
 * @types: The Lists a of arguments.
...
/**
 * print_percent - A fuction that Prints a percent sign.
 * @types: A List of arguments.
...
/********************** PRINT THE  BINARY ***********************/
/**
 * print_binary - A function tha Prints an unsigned number
 * @types: A List of arguments.
 * @buffer: A Buffer array to handle print
 * @flags:  A fuction that Calculates active flags.
 * @width: get The  width.
 * @precision: The Precision specification.
 * @size: The Size specifier.
